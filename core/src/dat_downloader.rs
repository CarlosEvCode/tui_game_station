...
impl DatDownloader {
    ...
    pub fn get_dat_relative_path(platform_slug: &str) -> Option<&'static str> {
        match platform_slug {
            "ds" | "nds" => Some("no-intro/Nintendo - Nintendo DS.dat"),
            ...
            "gamecube" => Some("redump/Nintendo - GameCube.dat"),
            "psp" => Some("no-intro/Sony - PlayStation Portable.dat"),
            "ps2" => Some("redump/Sony - PlayStation 2.dat"),
...
mod tests {
    ...
    fn test_get_dat_relative_path() {
        assert_eq!(
            DatDownloader::get_dat_relative_path("nds"),
            Some("no-intro/Nintendo - Nintendo DS.dat")
        );
        assert_eq!(
